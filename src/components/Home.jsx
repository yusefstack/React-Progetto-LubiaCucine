    ...
    <div className='h-2/5 overflow-hidden mt-20 relative'>
        ...
        <div className='mt-50 mb-32'>
          ...
          <div className='w-128 m-auto'>
            <Link to="/products" class="relative inline-flex items-center justify-center px-6 py-3 overflow-hidden font-bold text-white rounded-md shadow-2xl group">
              <span class="absolute inset-0 w-full h-full transition duration-300 ease-out opacity-0 bg-gradient-to-br from-blue-600 via-cyan-400 to-pink-300 group-hover:opacity-100"></span>
