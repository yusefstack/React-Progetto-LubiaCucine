...
return (
        <div className="h-126 w-4/5 rounded-xl m-10 shadow-cla-blue bg-gradient-to-r from-indigo-50 to-blue-50 overflow-hidden max-lg:m-auto max-lg:my-10">
            ...
            <div className="p-6">
                ...
                <button className="m-auto bg-gradient-to-r from-cyan-400 to-blue-400 hover:scale-105 drop-shadow-md  shadow-cla-blue px-4 py-1 rounded-lg md:max-lg:w-1/3 md:max-lg:p-4">Più info</button>
                </Link>
            </div>
    </div>
    )
